...
from Coverage import cover_circle_process
import time
...
def main():
    ...
    _, _, mask, _ =sim.plot_sat_az_el_rng_vis(gs_key="Sydney", sat_key=best["key"], min_elev_deg=0.0, plot=True, save_plot_path="elevation_series.png")
    res = cover_circle_process(mask, n=4, require_full=False)
